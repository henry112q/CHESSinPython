                ...
                if globals()[startSquare] == " ":
                    ...
                    if colour == 0 and globals()[startSquare][0] == "W":
                        if globals()[startSquare]=="WK":
                            WKM += 1
                        elif globals()[startSquare]=="WR1":
                            WR1M += 1
                        elif globals()[startSquare]=="WR2":
                            WR2M += 1
                        break
                    elif colour == 1 and globals()[startSquare][0] == "B":
                        if globals()[startSquare]=="BK":
                            BKM += 1
                        elif globals()[startSquare]=="BR1":
                            BR1M += 1
                        elif globals()[startSquare]=="BR2":
                            BR2M += 1
                        break
                    else:
...
while True:
    ...
    if startsquare[0] != "Castle":
        if globals()[startsquare[1]][-1] == "P":
            typeOfPiece = "P"
        elif globals()[startsquare[1]][-1] == "R":
            typeOfPiece = "R"
        elif globals()[startsquare[1]][-1] == "N":
            typeOfPiece = "N"
        elif globals()[startsquare[1]][-1] == "B":
            typeOfPiece = "B"
        elif globals()[startsquare[1]][-1] == "K":
            typeOfPiece = "K"
        elif globals()[startsquare[1]][-1] == "Q":
            typeOfPiece = "Q" 
